...
# Set up the app
app = App("emergency landing")
name = 0
text = Text(app, text="enter uri", size=32, font="Times New Roman", color="black")
# button = PushButton(app, lambda: display_greeting(1), text="add")
# button = PushButton(app, lambda: display_greeting(-1), text="add")
